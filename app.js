...
modsList:[
"فتح جميع استخدامات السندان 🔨",
"نظام المهارات ✨",
"تسجيل الدخول 🔑",
"التبادل بين اللاعبين 🤝",
"الخزنات الخاصة 🏦",
"إدارة الدردشة 💬",
"تنظيف اللاغ 🧹",
"التفاعل مع الكائنات 👆",
...
"حماية المزارع 🌾",
"دعم البيدروك 📱🖥️",
"ربط البيدروك بالجافا 🌐",
"حماية الأراضي 🚧",
"الجلوس والاستلقاء 🪑",
"إعادة تعبئة الصناديق 📦",
"طلبات الانتقال ✈️",
"إدارة الرتب والصلاحيات 👑",
"دار المزادات 🏛️",
"نظام السيرفر الأساسي ⚙️",
"النوم بلاعب واحد 😴",
"إخفاء الخامات عن الغش ⛏️",
"مكتبة البروتوكولات 📡",
"انتقال عشوائي 🌍",
"تجميع الموبات 🌹",
"تعيين المنزل 🏠",
